...
import { getPasskeyAllowedOrigins, getPasskeyRpIdForRequest } from "../../../lib/keys";
import { withApiErrorHandling } from "../../../lib/safeHandler";
import { verifyChallengeToken } from "../../../lib/passkey/challenge";
import { getProfileByCredentialId, updatePasskeyCounter } from "../../../lib/passkey/profiles";
import { mintSessionForUserId } from "../../../lib/passkey/supabaseAdmin";
