...
export const ONBOARDING = {
  ...
  snapSale: {
    ...
    quickHint: "Sticker price only — neighbors buy now, pay, then message you for pickup. No offers.",
    openHint: "Buy now or make an offer — you get a push on every offer to accept, counter, or pass.",
  ...
  garageAuction: {
    ...
    shopBanner: "Buy now at sticker price — or Offer when allowed. Paid → message seller for pickup.",
  ...
  garageSaleRules: {
    ...
    step2Body: "They make an offer. You get a push every time — accept, counter your price, or pass until you agree.",
    ...
    step4Body: "Auction winner pays within 30 minutes or the lot goes to the next bidder. Then you arrange pickup.",
  ...
  garageShelfEdit: {
    ...
    noteLabel: "Note",
    priceLabel: "Asking price",
    noStartingBidHint: "No starting bid — neighbors offer their price, or an auction starts if several want it.",
    modeQuick: "Quick sale",
    modeOpen: "Open to offers",
    save: "Save changes",
