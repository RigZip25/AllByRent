...
export const ONBOARDING = {
  ...
  snapSale: {
    ...
    publishedHintFirst: "Your garage shop is live — snap more or open your shelf to edit.",
    publishedHintMore: "Another item tagged — keep snapping or edit your shelf.",
    snapAnotherCta: "Snap another item",
    viewShopCta: "My active garage →",
