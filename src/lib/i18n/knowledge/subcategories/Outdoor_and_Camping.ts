...
/** Canonical EN subcategory FactCards for Outdoor & Camping — host-facing Q→A only. */
export const subs_Outdoor_and_Camping: Record<string, CategoryFactBlock> = {
  Tents: {
    title: "Tents tips",
    summary: "Peer tent rentals work when sleeps band, season rating, packed weight, and a sanitized/aired attestation are listed before booking.",
    qa: [
      {
        q: "What details apply before I can rent a tent?",
        a: "Rent listings list person capacity, season rating, and a hygiene checklist. The host must attest sanitized/aired; you acknowledge return clean and dry at booking.",
      },
      {
  ...
  "Camp Cooking": {
    title: "Camp cooking tips",
    summary: "Stoves and cook kits need fuel type listed with capacity/season context so renters bring the right canisters and return every piece.",
    qa: [
      {
        q: "What should I fill in?",
  ...
  "Navigation & GPS": {
    ...
    qa: [
      ...
      },
      {
        ...
        a: "Only if listed. Offline map packs and satellite subscriptions are host-declared—not an Evorios Garmin/onX partner offer.",
      },
      {
      ...
      },
      {
        ...
        a: "Not by default on personal Navigation & GPS. Survival / expedition shelves carry separate waiver requirements.",
      },
      {
        q: "What should I photograph?",
  ...
  Other: {
    title: "Outdoor other tips",
    summary: "Prefer a named Outdoor shelf so hygiene, fuel, or waiver details apply. Other still lists capacity and season on rent.",
    qa: [
      {
        q: "Should I stay on Other?",
        a: "move to a named category to Tents, Sleeping Bags, Backpacks, Camp Cooking, Navigation, Expedition Tents, Survival Gear, Group Shelters, Professional Navigation, or Base Camp when one fits.",
      },
      {
      ...
      {
        q: "Do hygiene or waiver details apply?",
        a: "Only if the host marks them required, or the item is clearly tent/sleep or survival/expedition-like. Named shelves enforce those requirements automatically.",
      },
      {
        q: "What should I photograph?",
  ...
  "Expedition Tents": {
    title: "Expedition tents tips",
    summary: "Alpine/expedition shelters list capacity, season, hygiene attestation, and a liability waiver before booking.",
    qa: [
      {
        q: "What should I fill in?",
  ...
  "Survival Gear": {
    title: "Survival gear tips",
    summary: "Survival kits list capacity/season context and a liability waiver so renters know risk stays with ordinary use between peers.",
    qa: [
      {
        q: "What should I fill in?",
  ...
  "Professional Navigation": {
    ...
    qa: [
      ...
      {
        q: "Is a waiver required?",
        a: "Not by default on this shelf. Survival Gear and Expedition Tents carry hard waiver requirements when risk is higher.",
      },
      {
        q: "What should I photograph?",
  ...
  "Base Camp Equipment": {
    ...
    qa: [
      ...
      {
        q: "Hygiene or waiver?",
        a: "Not by default. If the kit includes tents or sleep gear, move to a named category those pieces so hygiene/waiver details apply.",
      },
      {
