...
/** Canonical EN subcategory FactCards for Baby & Kids — host-facing Q→A only. */
export const subs_Baby_and_Kids: Record<string, CategoryFactBlock> = {
  ...
  "Cribs & Beds": {
    ...
    qa: [
      ...
      },
      {
        ...
        a: "Sleep standard, recall, mattress, and sanitize checks at booking.",
      },
    ],
  },
  Strollers: {
  ...
  Other: {
    ...
    qa: [
      ...
      {
        q: "Wrong category?",
        a: "move to a named category to get expiry, sleep, and install checks.",
      },
    ],
  },
  ...
  "Safety Systems": {
    ...
    summary: "Short answers for requirements, monitors, and install paths.",
    qa: [
      {
      ...
      {
        q: "Pressure baby requirements on stairs?",
  ...
  "Childcare Equipment": {
    ...
    qa: [
      ...
      {
        q: "What does the renter acknowledge?",
        a: "Hygiene and recall checks at booking.",
      },
    ],
  },
};
