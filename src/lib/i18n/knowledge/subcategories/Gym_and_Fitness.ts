...
/** Canonical EN subcategory FactCards for Gym & Fitness */
export const subs_Gym_and_Fitness: Record<string, CategoryFactBlock> = {
        "Boxing Equipment": {
          title: "Boxing — gear type, size, hygiene, use",
          summary: "Weekend gym kits beat vague peer ads when gear type, bag weight, glove size, wipe/liner rules, pair inventory, stand/mount, and bag-only vs sparring policy are frozen with the waiver.",
          qa: [
            {
            ...
            },
            {
              q: "What is the hygiene / wipe or liner policy?",
                a: "Hosts state wipe-before-return, liner or wraps required, host sanitizes between rentals, renter brings own gloves, or not skin-contact (bag hardware only). Soft notes may add spray or disposable liner details — not a laundry partner promo.",
            },
            {
            ...
            },
            {
              q: "What is bag-only vs sparring use policy?",
                a: "Hosts set bag-only, pads drill only, sparring allowed under host rules, or demo/display only. Evorios does not certify coaches or sanction sparring — the host’s published rule is what freezes on the agreement.",
            },
            {
        ...
        "Cardio Equipment": {
          title: "Cardio equipment — type, weight, wipe",
          ...
          qa: [
            {
              q: "What gates apply before I can rent cardio equipment?",
                a: "Rent listings freeze brand, model, cardio type, foldable status, plug vs battery power, equipment weight band, max user weight band, stairs move-in disclosure, hygiene wipe policy, warranty-not-included note, and liability waiver status. Soft tips cover floor protection and footprint.",
            },
            {
              q: "Bike, elliptical, rower — or a commercial treadmill?",
                a: "This personal shelf is for home upright/spin/recumbent bikes, ellipticals, rowers, stair climbers, and other home cardio. Full-size commercial treadmills belong on Commercial Treadmills so pro move and capacity gates apply.",
            },
            {
            ...
            },
            {
              q: "Is manufacturer warranty or gym insurance included?",
                a: "No. Peer rentals are as-is with a soft warranty-not-included note. Evorios does not sell gym insurance, connected-fitness subscriptions, or Planet Fitness / Peloton / Mirror / Tonal affiliate plans.",
            },
            {
              q: "If something goes wrong after the rental?",
                a: "Published wipe policy, weight limits, and machine specs are frozen on the agreement. Damage from misuse, missing batteries against listed power needs, or unclean return beyond wipe policy are handled via deposit and messages — not via insurance upsell.",
            },
          ],
        },
        "Commercial Treadmills": {
          title: "Commercial treadmills — power, weight, move",
          ...
          qa: [
            ...
            {
              q: "What is not included?",
                a: "Evorios does not underwrite gym injury, sell gym insurance, or partner with Life Fitness dealers, Peloton, Planet Fitness, or gym-insurance promos. Waiver + deposit + host disclosures are the primary layers.",
            },
          ],
        },
        "Competition Gear": {
          title: "Competition gear — discipline, plates, kit",
          summary: "Meet loans beat vague ads when discipline, soft federation notes, calibrated vs training plates, kit inventory, and host-declared bar notes are frozen with the waiver — without claiming platform IWF approval.",
          qa: [
            {
            ...
            },
            {
              q: "How do waiver, deposit, and claims work?",
                a: "The liability waiver covers ordinary-use injury risk when required. The deposit covers bent bars, missing plates, and damaged collars against the frozen inventory. Evorios does not sell competition or sports insurance.",
            },
            {
              q: "What is not included?",
        ...
        "Free Weights": {
          title: "Free weights — pairs, floor, drop rules",
          ...
          qa: [
            {
              q: "What gates apply before I can rent free weights?",
                a: "Rent listings freeze weight band, pair/single/set form, piece-count band, rack/stand inclusion, coating type, floor-protection rule, drop policy, and liability waiver status. Multi-piece sets also require a short kit checklist of every included piece.",
            },
            {
              q: "Pair vs set — why does piece count matter?",
                a: "A matched pair is two pieces; a set kit may include many dumbbells, plates, collars, and clamps. The checklist freezes what must return — missing plates or collars are the top free-weight handoff dispute.",
            },
            {
            ...
            {
              q: "What is not included?",
                a: "Manufacturer warranty transfer, gym memberships, spotting services, and third-party gym insurance are not included. Evorios does not sell Planet Fitness plans or insurance affiliate products.",
            },
            {
              q: "If something goes wrong after the rental?",
                a: "Published kit list, drop policy, and coating/floor rules are frozen on the agreement. Missing pieces, floor damage against mat-required, or drops against no-drop policy are handled via deposit and messages.",
            },
          ],
        },
        "Other": {
          title: "Other — pick the right gym shelf first",
          summary: "Prefer a named Gym & Fitness shelf so the right gates apply. If you stay on Other, declare type (cardio/weights/yoga/recovery/boxing/competition/training/mixed), keep weight band and waiver, attest condition photos, and list every piece when multi-piece.",
          qa: [
            {
              q: "Should I use Other or a named shelf?",
                a: "Re-shelf whenever a specific shelf fits — Yoga & Pilates, Cardio Equipment, Free Weights, Resistance Bands, Recovery Tools (personal), or Commercial Treadmills, Weight Machines, Boxing Equipment, Competition Gear, Training Systems (professional). Named shelves carry the right power, drop, hygiene, or capacity gates; Other is only for items that truly do not fit.",
            },
            {
            ...
            },
            {
              q: "Why are weight band and waiver still required?",
                a: "Gym & Fitness requires a weight/resistance band category-wide and a liability waiver status on rent. Other does not skip those floors — even catch-all listings freeze how heavy the gear is and whether a waiver is required at booking.",
            },
            {
              q: "Do I need max user weight on Other?",
                a: "Hard max-user-weight gates live on Cardio Equipment, Commercial Treadmills, and Weight Machines. If your Other item is cardio-like, add a max user weight when you can — or re-shelf so the hard gate applies.",
            },
            {
            ...
            },
            {
              q: "Waiver vs injury — and what is not included?",
                a: "The waiver (when required) covers ordinary-use injury risk between peers; the deposit covers damaged or missing gear. Evorios does not sell gym insurance, Peloton/Mirror/Tonal subscriptions, or Planet Fitness affiliate plans — warranty transfer is not implied on Other.",
            },
            {
              q: "How do claims work on Other?",
                a: "Use condition photos, inventory, weight band, and deposit hold for missing pieces or damage. Prefer a named shelf next time so specialist gates (wipe, drop, max user weight, power) are frozen on the agreement from the start.",
            },
          ],
        },
        "Recovery Tools": {
          title: "Recovery tools — type, runtime, wipe, waiver",
          ...
          qa: [
            {
              q: "What tool types are on this shelf?",
                a: "Foam rollers, massage guns, other percussion devices, ice/heat packs, massage-ball kits, or mixed recovery kits. Pick the type that matches what you will use so runtime and intensity gates apply correctly.",
            },
            {
            ...
            {
              q: "What is not included?",
                a: "No physical-therapy appointment, clinical diagnosis, or gym membership unless the host states it. Evorios does not sell gym insurance or percussion-brand affiliate coverage — deposit and rental terms handle damage and missing pieces.",
            },
          ],
        },
        "Resistance Bands": {
          title: "Resistance bands — level, pieces, wear, waiver",
          ...
          qa: [
            ...
            },
            {
              q: "What is snap/wear disclosure?",
                a: "Hosts grade bands from like-new to visible nicks or replace-soon. Inspect at handoff; worn latex can fail under load. The grade freezes the baseline so normal stretch marks are not confused with new damage.",
            },
            {
              q: "Waiver vs deposit — what covers what?",
            ...
            {
              q: "What is not included?",
                a: "No personal trainer, gym floor access, or membership unless the host states it. Evorios does not sell gym insurance or sporting-goods affiliate coverage — deposit and rental terms handle damage and missing pieces.",
            },
          ],
        },
        "Training Systems": {
          title: "Training systems — type, install, wipe",
          summary: "Studio pop-ups beat vague ads when system type, anchor/install, resistance band, max users, kit inventory, clearance height, and wipe hygiene are frozen with the waiver — without Mirror, Tonal, or TRX promo.",
          qa: [
            {
            ...
            },
            {
              q: "What is the wipe hygiene policy?",
                a: "Hosts set wipe grips after each use, wipe before return, host sanitizes between, screen-and-grips wipe, or N/A outdoor-only. Soft notes may list approved cleaners — not a janitorial partner promo.",
            },
            {
              q: "Why is a kit checklist required?",
        ...
        "Weight Machines": {
          title: "Weight machines — type, stack, footprint",
          ...
          qa: [
            ...
            {
              q: "What is not included?",
                a: "Evorios does not underwrite gym injury, sell gym insurance, or partner with Life Fitness dealers, Rogue affiliates, or gym-insurance promos. Waiver + deposit + host disclosures are the primary layers.",
            },
          ],
        },
        "Yoga & Pilates": {
          title: "Yoga & Pilates — mat, kit, wipe, waiver",
          ...
          qa: [
            ...
            {
              q: "What is not included?",
                a: "No studio class, instructor, or gym-membership access unless the host states it. Evorios does not sell gym insurance or Planet Fitness / studio affiliate coverage — deposit and rental terms handle damage and missing pieces.",
            },
          ],
        },
      };
