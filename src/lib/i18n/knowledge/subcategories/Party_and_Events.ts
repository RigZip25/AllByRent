...
/** Canonical EN subcategory FactCards for Party & Events — host-facing Q→A only. */
export const subs_Party_and_Events: Record<string, CategoryFactBlock> = {
  "Tables & Chairs": {
    title: "Tables & chairs tips",
    summary: "Folding sets rent cleanly when piece count, guest capacity, footprint, and optional setup fee are listed on the agreement.",
    qa: [
      {
  ...
  "Tents & Canopies": {
    ...
    qa: [
      ...
      },
      {
        ...
        a: "Yes for outdoor tents/canopies — full refund 24h, 12h, host discretion, or not_outdoor if truly indoor-only. The window goes on the rental agreement.",
      },
      {
      ...
      },
      {
        ...
        a: "Personal tent shelves do not force a power band; add soft notes if you need lights or heaters. Pro lighting/sound shelves carry power requirements.",
      },
      {
        q: "What does the deposit cover?",
      ...
      {
        q: "What is not included?",
        a: "Permit pulls, electrician hookups, and third-party tent insurance is not part of booking.",
      },
    ],
  },
  "Party Decor": {
    title: "Party décor tips",
    ...
    qa: [
      {
        ...
        a: "Guest capacity band, recommended color, and setup footprint. Soft décor does not require catering sanitize or pro power requirements.",
      },
      {
  ...
  "Games & Activities": {
    ...
    qa: [
      ...
      {
        q: "What is not included?",
        a: "Staffed carnival operators, prize inventory, and big-box party-game insurance.",
      },
    ],
  },
  "Serving Equipment": {
    title: "Serving equipment tips",
  ...
  Other: {
    title: "Party other tips",
    summary: "Catch-all party gear still publishes guest capacity and footprint; move to Tables, Tents, Decor, Games, Serving, Stage, Sound, Lighting, Photo Booths, or Catering when those requirements fit.",
    qa: [
      {
        q: "When should I use Other?",
        a: "Only when no named Party shelf fits. Named shelves carry tent size, piece count, power, or sanitize requirements renters expect.",
      },
      {
      ...
      },
      {
        ...
        a: "Stage, sound, lighting, photo booths, and catering belong on professional shelves so power and sanitize details apply.",
      },
      {
        q: "What does the deposit cover?",
  ...
  "Stage & Risers": {
    ...
    qa: [
      ...
      },
      {
        ...
        a: "Yes for pro stages — when published, the fee goes on the rental agreement with who installs risers.",
      },
      {
  ...
  "Photo Booths": {
    title: "Photo booths tips",
    summary: "Booth rentals list power needs, guest capacity, footprint, and optional setup fee; count props and printers at handoff.",
    qa: [
      {
      ...
      {
        q: "Is setup included?",
        a: "When a setup/teardown fee is published, host install goes on the rental agreement. Otherwise renter assembles per instructions.",
      },
      {
  ...
  "Catering Equipment": {
    ...
    qa: [
      ...
      },
      {
        ...
        a: "Catering Equipment is the pro shelf — power requirements plus sanitize. Personal Serving Equipment focuses on sanitize and capacity without pro power.",
      },
      {
