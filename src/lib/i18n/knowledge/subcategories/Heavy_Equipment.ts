...
/** Canonical EN subcategory FactCards for Heavy Equipment — host-facing Q→A only. */
export const subs_Heavy_Equipment: Record<string, CategoryFactBlock> = {
  Generators: {
    title: "Generators tips",
    summary: "Portable and home standby generators rent cleanly when phase, start method, runtime, transfer-switch status, noise, power/fuel, insurance, and cord/oil kit inventory are listed.",
    qa: [
      {
        q: "What details apply before I can rent a generator?",
        a: "Rent listings list brand, power class, fuel, phase, start method, runtime band, transfer-switch inclusion, noise band, liability/deductible insurance bands, and a short kit checklist (cords, oil, funnel). Pros-only stays on unless the host turns it off.",
      },
      {
  ...
  "Air Compressors": {
    title: "Air compressors tips",
    summary: "Neighbor compressors need CFM, tank size, max PSI, drive type, hose/coupler kit status, power/fuel, insurance, and inventory before you publish.",
    qa: [
      {
        q: "What should I fill in?",
        a: "List brand, power/fuel, CFM band, tank size, max PSI, drive type, hose/coupler kit inclusion, insurance bands, and kit checklist.",
      },
      {
  ...
  "Pressure Washers": {
    ...
    qa: [
      {
        q: "What should I fill in?",
        a: "List PSI, GPM, power source, wand/nozzle kit, surface-use policy, power/fuel class, insurance bands, and kit checklist.",
      },
      {
  ...
  Winches: {
    ...
    qa: [
      {
        q: "What should I fill in?",
        a: "List capacity band, mount, line type, remote, snatch-block inclusion, power/fuel, insurance, kit checklist, plus general heavy operator proof.",
      },
      {
      ...
      },
      {
        ...
        a: "Line type is listed on the listing. Do not substitute. Kinks, bird-nesting, or cut strands against photos are claim baselines.",
      },
      {
  ...
  Pumps: {
    ...
    qa: [
      {
        q: "What should I fill in?",
        a: "List pump type, GPM band, inlet/outlet size, solids handling, hose kit, power/fuel, insurance, and checklist.",
      },
      {
  ...
  "Industrial Generators": {
    title: "Industrial generators tips",
    ...
    qa: [
      {
        q: "What extra requirements vs personal Generators?",
      ...
      },
      {
        ...
        a: "Mount form lists transport and set-down expectations. Towing a trailer-mounted set may need a separate tow vehicle listing.",
      },
      {
        q: "Insurance and deposit?",
  ...
  Forklifts: {
    title: "Forklifts tips",
    summary: "Forklift rentals list class, lift capacity, mast height, tires, fuel/battery, operator manual status, hours, insurance, and forklift operator credential.",
    qa: [
      {
        q: "What should I fill in?",
        a: "List forklift class, capacity, mast height, tire type, fuel/battery, operator manual inclusion, power/fuel/hours, insurance bands, and forklift credential upload.",
      },
      {
      ...
      },
      {
        ...
        a: "Fuel/battery band lists who supplies fuel or charged batteries and return state.",
      },
      {
        q: "Insurance and deposit?",
  ...
  "Industrial Compressors": {
    title: "Industrial compressors tips",
    ...
    qa: [
      {
        q: "What extra requirements vs personal Air Compressors?",
  ...
  "Hydraulic Equipment": {
    ...
    qa: [
      {
        q: "What should I fill in?",
        a: "List hydraulic function, PSI, flow GPM, coupler type, hose-whip kit, power/fuel, insurance, checklist, plus general heavy operator proof.",
      },
      {
        q: "Do I need an operator credential?",
  ...
  "Heavy Pumps": {
    ...
    qa: [
      {
        q: "What extra requirements vs personal Pumps?",
  ...
  Other: {
    title: "Heavy other tips",
    summary: "Catch-all heavy gear must declare kind, piece count, photo condition depth, category power/fuel/insurance floors — move to a named category when a named shelf fits.",
    qa: [
      {
        q: "When should I use Other?",
        a: "Only when Generators, compressors, washers, winches, pumps, forklifts, or hydraulic shelves truly do not fit. Named shelves carry the right capacity and credential requirements.",
      },
      {
        q: "What requirements still apply?",
        a: "Kind, piece band, photo condition checklist, power/fuel, insurance bands. Multi-piece needs a kit inventory list.",
      },
      {
        q: "Do I need an operator credential?",
        a: "If kind is forklift, winch, hydraulic, industrial generator/compressor, or heavy pump — move to a named category so the credential gate applies. Other does not skip pro/insurance floors.",
      },
      {
        q: "Photo condition checklist?",
        a: "Overall photos, overall plus flaws, or all pieces and flaws — lists claim baseline before handoff.",
      },
      {
        q: "Insurance and deposit?",
