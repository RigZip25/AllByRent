...
/** Canonical EN subcategory FactCards for Vehicles — host-facing Q→A only. */
  ...
  "Special Vehicles": {
    ...
    qa: [
      ...
      },
      {
        ...
        a: "Move it to Cars, Trucks, Trailers, ATVs, RVs, or Tow when one of those fits better.",
      },
    ],
  },
  Other: {
    ...
    qa: [
      {
        ...
        a: "Move it to a named Vehicles shelf when it fits so the right license, insurance, and inspection details apply.",
      },
      {
