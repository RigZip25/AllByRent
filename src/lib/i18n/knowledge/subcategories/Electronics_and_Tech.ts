...
/** Canonical EN subcategory FactCards for Electronics & Tech — host-facing Q→A only. */
    ...
    qa: [
      {
        ...
        a: "Prefer a named shelf (Laptops, Projectors, Gaming, etc.) so the right details apply.",
      },
      {
