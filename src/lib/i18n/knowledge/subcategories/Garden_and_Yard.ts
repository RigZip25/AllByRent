...
/** Canonical EN subcategory FactCards for Garden & Yard — host-facing Q→A only. */
export const subs_Garden_and_Yard: Record<string, CategoryFactBlock> = {
  "Garden Tools": {
    title: "Garden tools tips",
    summary: "Tool counters and neighbor sets win when single vs set, surface fit, wear grade, and mud return rules are clear.",
    qa: [
      {
      ...
      },
      {
        ...
        a: "Honest wear on handles, heads, tines, and wheelbarrow trays or tires — including light rust that still works. It lists the baseline so normal soil wear is not confused with new damage after return.",
      },
      {
      ...
      },
      {
        ...
        a: "No professional landscaping crew, soil delivery, or disposal haul-away unless the host states it in the listing. Evorios does not sell yard-insurance or Home Depot / Sunbelt / United Rentals partner offer coverage — deposit and rental terms handle damage and missing pieces.",
      },
    ],
  },
  "Houseplants & Seedlings": {
    title: "Houseplants tips",
    summary: "Indoor rentals fail on light, water, and pet surprises.",
    qa: [
      {
    ...
    qa: [
      {
        ...
        a: "Pick drip for emitter/tubing kits, sprinkler_zones for pop-up or rotor zone manifolds, smart_controller when a Wi‑Fi/timer hub is the main rental, or pump when the kit centers on a booster or transfer pump.",
      },
      {
      ...
      },
      {
        ...
        a: "Soft seasonal guidance only: drain lines, blow out if offered, store indoors before frost. They are not list-damage insurance and do not promise the host will winterize unless explicitly stated in the listing notes.",
      },
      {
        q: "How do deposit and claims usually work?",
        a: "Cut tubing, lost heads, cracked manifolds, or a missing smart controller typically come out of the deposit when inventory and handoff photos support the claim.",
      },
      {
        q: "What is not included?",
        a: "Water bill, permanent plumbing permits, guaranteed main-line tap access, backflow testing certification, and pro install labor unless install complexity says host installs.",
      },
    ],
  },
  "Landscape Equipment": {
    title: "Landscape equipment tips",
    summary: "Pro yards label aerators, dethatchers, sod cutters, spreaders, and carts with brand, model, power, gas fuel when applicable, a full kit checklist, and load/transport notes — listed on the agreement.",
    qa: [
      {
      ...
      },
      {
        ...
        a: "Subtype tells the job (aerate vs dethatch vs cut sod vs spread). Brand and model list the exact machine — Ryan, BlueBird, and Husqvarna-class units differ in weight, tines, and hopper size.",
      },
      {
      ...
      },
      {
        ...
        a: "When power is gas, declare fuel type (gasoline, diesel, propane). Say whether the renter returns a full tank, same level, or refills — host policy is listed on the listing.",
      },
      {
      ...
      {
        q: "What is not included?",
        a: "Material (seed, sod, fertilizer), site prep, disposal, operator training beyond the listing, and third-party rental-desk or yard-insurance products are not included. Deposit covers damage or missing kit items per the listed checklist and photos.",
      },
    ],
  },
  "Lawn Mowers": {
    title: "Lawn mowers tips",
    summary: "Tool-rental counters list deck width, fuel, and clean-return rules.",
    qa: [
      {
        q: "Why are cutting width, model, and power source required?",
        a: "Deck width (under 16 in through 30 in+) tells you if the mower fits your yard and requirements. Model plus brand separates push vs self-propelled and year class — brand and \"gas\" alone are not enough to book confidently.",
      },
      {
      ...
      },
      {
        ...
        a: "Gas listings require fuel type (gasoline, propane, other) and a return rule: full-to-full, host provides starting fuel, or renter buys own.",
      },
      {
      ...
      },
      {
        ...
        a: "Published return-clean and fuel policies plus blade/discharge specs are listed on the agreement.",
      },
    ],
  },
  "Leaf Blowers": {
    title: "Leaf blowers tips",
    summary: "Tool-rental counters quote form factor, CFM class, and vac kit on the card.",
    qa: [
      {
  ...
  "Nursery Stock": {
    title: "Nursery stock tips",
    summary: "Wholesale nursery tags drive pro jobs.",
    qa: [
      {
  ...
  Other: {
    ...
    qa: [
      ...
      },
      {
        ...
        a: "Prefer a named plant shelf for height, sun, container, and water requirements. If you stay plant-only on Other, add sun, pot size, and water needs when you can — renters need care basics before booking.",
      },
      {
      ...
      },
      {
        ...
        a: "Use condition photos, inventory, power source, and deposit hold for missing batteries, broken blades, or damaged pots. Prefer a named shelf next time so specialist requirements are listed on the agreement from the start.",
      },
    ],
  },
  Perennials: {
    title: "Perennials tips",
    summary: "Nursery tags list cultivar, bloom window, and water band.",
    qa: [
      {
  ...
  "Ride-On Mowers": {
    title: "Ride tips",
    summary: "Large-lot mowers need deck width, fuel, hours, blade/deck setup, and transport listed before book — plus a light operator briefing, not a CDL path.",
    qa: [
      {
      ...
      },
      {
        ...
        a: "Equipment yards quote both so renters match lawn size and wear. A listed width band and hour band on the listing beats surprise under-sized decks or tired engines mid-job.",
      },
      {
  ...
  "Seasonal Flowers": {
    title: "Seasonal flowers tips",
    summary: "Event plant rentals live on peak color and return-in-pot rules.",
    qa: [
      {
      ...
      {
        q: "What is NOT included?",
        a: "No delivery crew, daily watering service, or frost cloth from Evorios unless your listing adds it. We do not sell nursery or florist partner offer products.",
      },
      {
        q: "How do deposits work?",
  ...
  "Shrubs & Bushes": {
    title: "Shrubs tips",
    summary: "Nurseries and event rentals tag cultivar, bloom window, and pot size.",
    qa: [
      {
  ...
  Sprinklers: {
    title: "Sprinklers tips",
    summary: "Peer lawn bursts beat retail when coverage band, hose connection type, timer inclusion, multi-head inventory, and drain return notes are listed on the agreement.",
    qa: [
      {
      ...
      },
      {
        ...
        a: "Timer included says whether a hose timer ships with the heads or the listing is timer-only. Power source is manual for passive sprinklers and usually cordless for battery timers — both are listed on the agreement so the renter knows what batteries or hose setup to bring.",
      },
      {
      ...
      },
      {
        ...
        a: "Missing heads, stakes, timer bodies, or cracked quick-connect manifolds are checked against the listed inventory and handoff photos. Ordinary wear on spray patterns is expected; damage beyond the published return notes may use the deposit per rental terms.",
      },
      {
  ...
  "Stump Grinders": {
    ...
    qa: [
      ...
      {
        q: "What is not included?",
        a: "Evorios does not underwrite yard work, sell insurance. Deposit hold and renter proof are the primary layers.",
      },
    ],
  },
  "Tillers & Cultivators": {
    title: "Tillers & cultivators tips",
    summary: "Professional tillers need working width, depth band, tine condition, model, gas fuel type or cordless battery pack, and transport notes listed before handoff.",
    qa: [
      {
      ...
      {
        q: "How do deposits and claims work?",
        a: "Size deposit to engine, tines, and batteries. Bent tines, cracked gearboxes, or missing battery packs follow the rental terms and handoff photos — not an partner offer insurance upsell.",
      },
    ],
  },
  Trees: {
    title: "Trees tips",
    summary: "Local nurseries tag species, zone, and root format.",
    qa: [
      {
  ...
  Trimmers: {
    title: "Trimmers tips",
    summary: "Tool-rental counters list cutting swath, string vs blade head, harness, fuel mix or battery platform, and spool/blade wear on the ticket.",
    qa: [
      {
        q: "What do the listing requirements mean?",
        a: "Brand, model, power source, cutting width, head type, harness, fuel or battery band, line/blade condition, and kit checklist list on the rental agreement before you book.",
      },
      {
