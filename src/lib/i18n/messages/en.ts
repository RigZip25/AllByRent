  ...
  listing: {
    ...
    specs: {
      ...
      fields: {
        ...
        kitInventoryChecklist: { label: "Broadcast kit checklist", hint: "List every cable, plate, media card, remote, stand, and bag. Renter confirms at booking and handoff.", placeholder: "ATEM Mini Pro, 2× HDMI 1.5m, 1× SDI BNC 3m, AC PSU, USB-C capture cable, soft case…" },
