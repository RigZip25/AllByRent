  ...
  listing: {
    ...
    specs: {
      ...
      fields: {
        ...
        monitorKitIncluded: { label: "Monitor / dock kit", hint: "Recommended — monitor+dock, monitor only, renter brings gear, or none." },
      ...
      options: {
        ...
        gloves: "Gloves (pair)",
        ground_floor_easy: "Ground floor / easy carry",
