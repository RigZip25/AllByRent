...
export const en: AppMessages = {
  ...
  postRequest: {
    ...
    budgetNote: (budget, radius) => `Budget up to $${budget}/day · within ${radius}`,
    budgetNoteBuy: (budget, radius) => `Budget up to $${budget} to buy · within ${radius}`,
    budgetNoteEither: (budget, radius) =>
      `Budget up to $${budget}/day to rent or $${budget} to buy · within ${radius}`,
  ...
  listingQr: {
    ...
    pdfReady: "PDF ready",
    pdfReadyBody: "Download or print the file on this device. Sharing a website link won’t send the PDF.",
    download: "⬇️ Download",
    print: "🖨️ Print",
