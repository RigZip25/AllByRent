...
export const en: AppMessages = {
  ...
  home: {
    ...
    newGaragesTitle: "New on your block",
    newGaragesHint: "Opened in the last 2 weeks — say hi while they're fresh.",
    newGarageBadge: "New",
    proGarageBadge: "Pro",
  ...
  mrEvorios: {
    ...
    guides: "Guides",
    welcome: (mascot) =>
      `Hi! I'm ${mascot}. Ask anything about the app — I check FAQ first, then AI if needed.`,
  ...
  garageUi: {
    ...
    statusPaused: "Paused",
    statusNeedsQr: "Print sticker when ready",
  ...
  rentalDetail: {
    ...
    scanHandOverBody:
      "Scan the item QR and enter the pickup PIN to mark it handed over. The rental goes active when the neighbor also confirms receive.",
    scanReceiveBody:
      "Scan the item QR and enter the pickup PIN to confirm you received it. Both sides must confirm.",
    scanReturnItemBody:
    ...
    handoffHint: "QR + PIN — both cabinets must confirm each step.",
  ...
  listing: {
    ...
    qr: {
      ...
      publishBeforePrint:
        "Your listing goes live with a QR ready. Print stickers later — or in bulk — and use the code at handoff when a rental starts.",
  ...
  listingQr: {
    ...
    storySubtitle: (mascot) =>
      `Your listing is already live. ${mascot} explains handoff scans — print stickers now or later.`,
    ...
    stepSmartTip:
      "This QR links the physical item to a single listing. Print one now, or print many later and stick them when you’re ready.",
    stepPickupTitle: "Handoff starts with your code",
    stepPickupTip:
      "When a rental starts, you confirm handover with the code — the rental holds on your side. The neighbor scans to receive it; then it goes fully active and moves to their cabinet.",
    ...
    stickerReadySubtitle: "Look it over, print now, add to a bulk sheet — or close and print later.",
    listingAlreadyLive: "Your listing is already live for neighbors.",
    donePrintLater: "Done — I’ll print later",
    ...
    comeBackHint: "You can reopen this QR anytime from My Garage to print or verify.",
    verifyingQr: "Verifying QR…",
    takeVerificationPhoto: "📸 Take verification photo",
    verificationHint:
      "Optional. Point the camera at the printed QR on the item so we know the sticker is attached. Handoff at rental start still uses this code either way.",
    pdfReady: "PDF ready",
    pdfReadyBody:
