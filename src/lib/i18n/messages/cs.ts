...
export const cs: AppMessages = {
  ...
  profile: {
    ...
    connectIntroBody: "Evorios spolupracuje se Stripe na bance — stejný zelený + fialový vzhled uvidíš i dál.",
    connectIntroHint: "Když se objeví SMS kontrola, je to bezpečný krok — pořád Evorios + Stripe.",
    connectIntroAlt: "Náhled bezpečných výplat Evorios s Mr. Evorios",
    connectIntroCta: "Pokračovat bezpečně",
    connectIntroBack: "Zpět na náhled",
