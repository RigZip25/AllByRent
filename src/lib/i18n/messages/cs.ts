...
export const cs: AppMessages = {
  ...
  onboarding: {
    ...
    guestShowcase: {
      ...
      photosBody: "Vyfoť, co chceš sdílet. Evorios doplní název, kategorii a popis — a můžeš být online během minut.",
      enhanceTitle: "Fotky, které vypadají připravené",
      enhanceBody: "Vyčištění pozadí a světla — sousedé víc věří tomu, co dobře vidí.",
      rolesTitle: "Tři způsoby sdílení",
      rolesBody: "Jedna garáž, tři režimy. Kdykoli přepneš.",
      roleRent: "Půjčit",
      ...
      helpBody: (mascot) => `${mascot} odpovídá na otázky, navrhuje odpovědi a provede tě inzerátem i rezervací — jako asistent domácího byznysu.`,
      nextCta: "Další",
