...
export const cs: AppMessages = {
  ...
  common: {
    ...
    loading: "Načítání...",
    signIn: "Přihlásit se",
    idVerifiedAria: "Identita ověřena",
    phoneVerifiedAria: "Telefon ověřen",
  },
  ...
  nav: {
    ...
    activity: "Aktivita",
    more: "Účet",
    mainAria: "Hlavní navigace",
    homeAria: "Domů — prohlížet nebo moje garáž",
    mreAria: (mascot) => `Otevřít asistenta ${mascot}`,
    addAria: "Přidat věc do garáže",
    activityAria: "Aktivita — půjčky, zprávy, oblíbené",
    moreAria: "Účet — nastavení a preference",
  },
  activity: {
    title: "Aktivita",
  ...
  profile: {
    ...
    openingStripe: "Bezpečně se připojuji ke Stripe…",
    connectEmbeddedTitle: "Nastavení výplat",
    connectEmbeddedBody: "Přidejte bankovní údaje zde — zůstanete v Evorios.",
    ...
    connectIntroAlt: "Evorios a Stripe — bezpečné výplaty s Mr. Evorios",
    connectIntroCta: "Nastavit výplaty",
    connectIntroBack: "Zpět",
    connectSecureFooter: "Bankovní údaje zůstávají šifrované. Stripe zajišťuje platební infrastrukturu.",
    ...
    payoutsFlowHowBank: "Čistá částka jde na propojený účet — v běžném dni zůstáváte v Evorios.",
  ...
  garageUi: {
    ...
    householdShareLinks: "Pozvánku jsme poslali e-mailem. Záložní odkaz si pořád můžeš zkopírovat:",
    ...
    householdEmailPartialFail: (failed, total) =>
      `Uloženo ${total} pozvánek, ale ${failed} e-mail(ů) se neodeslalo. Použij kopírování / mail níže jako zálohu.`,
    ...
    storeLiveStripeGateTitle: "Pro otevření jsou nutné výplaty",
    ...
    storeLiveStripeOpening: "Otevírám výplaty…",
    ...
    storeLiveHelperBody: "Pomáháš v cizí garáži — sem dáváš věci; Live a výplaty zůstávají u majitele.",
  ...
  listing: {
    ...
    continue: "Pokračovat",
    validation: {
      addPhoto: "Přidejte alespoň jednu fotku.",
      pickCategory: "Vyberte kategorii.",
      pickGrade: "Vyberte osobní nebo profesionální.",
      pickSubcategory: "Vyberte podkategorii.",
      enterTitle: "Zadejte název.",
      pickCondition: "Vyberte stav.",
      enterReplacementValue: "Zadejte náhradní hodnotu.",
      enterSerial: "Zadejte sériové číslo.",
      enterVin: "Zadejte platné VIN.",
      completeCategorySpecs: "Doplňte povinné specifikace.",
      pickMode: "Zapněte Půjčit, Prodat nebo Zdarma.",
      enterDailyRate: "Zadejte denní sazbu.",
      enterWeeklyRate: "Zadejte týdenní sazbu.",
      enterMonthlyRate: "Zadejte měsíční sazbu.",
      enterSecurityDeposit: "Zadejte kauci (0 = bez držení).",
      enterLongTermRate: "Zadejte dlouhodobou měsíční sazbu.",
      enterSalePrice: "Zadejte prodejní cenu.",
      enterIncludedMiles: "Zadejte zahrnuté kilometry/den.",
      enterOveragePerMile: "Zadejte cenu za extra km.",
      enterInsuranceEmail: "Zadejte e-mail pro pojištění.",
      enterWheelCount: "Zadejte počet kol/pneumatik.",
    },
    ...
    photos: {
      ...
      clearRejectedPhotos: "Smazat fotky",
      retryWithNewPhotos: "Zkusit nové fotky",
    },
    itemInfo: {
      title: "Detaily věci",
      ...
      instructionsUrl: "Návod výrobce (volitelné)",
      instructionsPlaceholder: "https://… oficiální manuál nebo podpora",
      instructionsHelper:
        "Odkaz na manuál výrobce nebo jasný návod. Volitelné — nech prázdné, pokud ho nemáš.",
      assetIdentityHint:
    ...
    specs: {
      ...
      englishContentNote:
        "Některé detaily kategorie a volby zůstávají v angličtině — plný překlad přijde později.",
      ...
      fields: {
        brand: {
          ...
          hint: "Vyber jméno ze štítku — nebo Bez značky / Jiné.",
        },
        ...
        sizeOrLength: {
          label: "Velikost / délka", placeholder: "např. 170 cm",
          hint: "Když můžeš, použij číslo vyražené na vybavení.",
        },
        ...
        ladderDutyRating: {
          label: "Nosnost (ANSI)",
          hint: "Třída nosnosti Type IAA / IA / I / II / III.",
        },
        ...
        dropSideAcknowledged: {
          label: "Drop-side stav",
          hint: "US postýlky s odklopným bokem jsou zakázané — potvrď, že tahle taková není.",
        },
        ...
        ppeStandardRegion: {
          label: "Norma OOP",
          hint: "Třída ANSI / EN ze štítku — uvádí hostitel, ne certifikace platformy.",
        },
        ppeInspectionStatus: {
          label: "Stav prohlídky",
          hint: "Zachycovací OOP potřebuje platný štítek. Soft OOP může být „není potřeba“.",
        },
        craneCapacityTonsBand: {
          label: "Nosnost (tuny)",
          hint: "Jmenovitá nosnost — povinné u jeřábů a zvedání.",
        },
        craneOperatorMode: {
          label: "Bez obsluhy vs s obsluhou",
          hint: "S obsluhou přeskočí kvalifikaci nájemce na jeřáb.",
        },
        formworkPieceCountBand: {
          label: "Počet kusů",
          hint: "Kolik panelů / táhel / stojek jde se sadou.",
        },
        ...
        overnightStorageRule: {
          label: "Noční / venkovní uskladnění",
          hint: "Kde může kolo zůstat přes noc — noční venku často anuluje nárok.",
        },
        chargerIncluded: {
          label: "Nabíječka v ceně?",
          hint: "Zda jde s reproduktorem napájecí zdroj / USB nabíječka.",
        },
        batteryChargeBand: {
          label: "Očekávané nabití při předání",
          hint: "U aku / hybridních reproduktorů — měkké SOC očekávané při vrácení. Ne přesný ukazatel.",
        },
        ...
        eBikeClass: {
          label: "Třída e-kola",
          hint: "US Class 1–3. Povinné u E-Bikes a u kol s Electric = ano.",
        },
    ...
    review: {
      ...
      handoffAdjustHint: "Vyzvednutí, doručení a dostupnost — upravíte v Detaily.",
      paused: "Pozastaveno",
  ...
  booking: {
    ...
    goBackAria: "Zpět",
    fewerDaysAria: "O jeden den méně",
    moreDaysAria: "O jeden den víc",
  ...
  faq,
  categoryFacts: {
    ...resolveCategoryFacts(categoryFactsCsOverlay),
    englishContentNote:
      "Většina tipů ke kategoriím je zatím v angličtině. Vehicles má český překlad; ostatní police doplníme později.",
  },
  preTripInspection: {
  ...
  moderation: {
    reportListing: "Nahlásit tento inzerát",
    reportMessage: "Nahlásit tuto zprávu",
    reportUser: "Nahlásit tohoto člověka",
    reportRequest: "Nahlásit tuto poptávku",
    blockUser: "Zablokovat",
    unblockUser: "Odblokovat",
    blockedBadge: "Zablokováno",
    blockedNotice: "Tohoto člověka jsi zablokoval. Jeho inzeráty a zprávy se ti nezobrazují.",
    blockConfirmTitle: "Zablokovat tohoto člověka?",
    blockConfirmBody:
      "Neuvidíš jeho inzeráty, poptávky ani zprávy a nemůže ti napsat. Zrušit to můžeš na jeho profilu.",
    unblockConfirmBody: "Jeho inzeráty a zprávy se zobrazí znovu.",
    sheetTitle: "Napiš, co se stalo",
    sheetSubtitle: "Každé hlášení čte moderátor. Nahlášený člověk nic neuvidí.",
    reasonLabel: "Co se stalo?",
    detailsLabel: "Chceš ještě něco doplnit?",
    detailsPlaceholder: "Nepovinné — co jsi viděl, kdy a kde",
    detailsRequired: "Popiš prosím, co se stalo.",
    submit: "Odeslat hlášení",
    submitting: "Odesílám...",
    cancel: "Zrušit",
    thanksTitle: "Hlášení odesláno",
    thanksBody: "Díky — moderátor se na to podívá. Když bude potřeba, napíšeme ti e-mail.",
    alsoBlock: "Zablokovat i tohoto člověka",
    alreadyReported: "Tohle už jsi nahlásil. Řešíme to.",
    signInNeeded: "Pro nahlášení se přihlas, aby se s tebou moderátor mohl spojit.",
    reasons: {
      harassment: "Obtěžování nebo hrozby",
      scam: "Podvod",
      off_platform: "Chce platit nebo psát mimo aplikaci",
      sexual: "Sexuální nebo explicitní obsah",
      hate: "Nenávistné projevy",
      violence: "Násilí nebo sebepoškozování",
      illegal_item: "Nelegální nebo zakázaná věc",
      not_as_described: "Věc neodpovídá popisu",
      spam: "Spam",
      other: "Něco jiného",
    },
    moreActionsAria: "Další akce",
  },
  peerChat: {
    title: "Chat",
    tip: (mascotHandle) =>
  ...
  onboarding: {
    ...
    allSet: {
      ...
      profileHeading: (appName) => `Tvůj profil ${appName}`,
      typeLabel: "Typ",
      blockLabel: "Blok",
      focusLabel: "Zaměření",
      accountPersonal: "Jednotlivec",
      accountPro: "Pro / byznys",
      visiting: "Na návštěvě",
      onMyBlock: "Na mém bloku",
      exploreTag: "Prozkoumat",
    },
    browseHub: {
      title: "Poblíž tebe",
    ...
    authWelcome: {
      ...
      subtitle: 'Nejdřív se podívej, jak sousedé sdílejí věci poblíž. Účet vytvoř, až budeš listovat, rezervovat nebo psát.',
      signInCta: 'Přihlásit se',
      signUpCta: 'Vytvořit účet',
      continueGuestCta: 'Prohlížet jako host',
      faceIdSubtitle: 'Vítej zpět — pokračuj Face ID, nebo prohlížej jako host.',
      guestHint: 'Prohlížení je zdarma. Účet až když něco uděláš.',
      returningTitle: 'Vítej zpět',
      returningSubtitle: 'Na tomto telefonu už je tvůj účet Evorios. Přihlas se a otevři garáž.',
      signInEmailCta: 'Přihlásit e-mailem',
      returningHint: 'Face ID nebo e-mail — stejný účet a nastavení.',
    },
    guestShowcase: {
      hookTitle: "Tvůj dům je obchod na bloku",
      hookBody: "Evorios mění věci z domácnosti ve výlohu pro sousedy — půjčuj poblíž, nebo sdílej, co máš.",
      browseTitle: "Nejdřív se podívej poblíž",
      browseBody: "Prohlížej garáže a věci na bloku ještě před založením účtu.",
      modesTitle: "Jedna věc. Tři možnosti.",
      modesBody: "Kdykoli přepneš — bez zakládání znovu.",
      roleRent: "Půjčit",
      roleSell: "Prodat",
      roleGift: "Darovat",
      snapTitle: "Vyfoť — text napíšeme my",
      snapBody: "Jedna fotka. Název, kategorie a popis se doplní sami.",
      enhanceTitle: "Fotky, které vypadají připravené",
      enhanceBody: "Čistší pozadí a lepší světlo — sousedé víc věří tomu, co dobře vidí.",
      stockTitle: "Naplň garáž během minut",
      stockBody: "Doplň polici z toho, co už doma máš. Spusť, až budeš připravený.",
      bookTitle: "Rezervuj a plať v aplikaci",
      bookBody: "Vyber termín i zálohu a zaplať bezpečně v Evorios.",
      trustTitle: "Důvěra na bloku",
      trustBody: "Face ID, ověřené profily, recenze a výplaty přímo v aplikaci.",
      yardTitle: "Yard sale a snap aukce poblíž",
      yardBody: "Otevři výprodej nebo rychlou aukci — sousedé hledají, co je lokální.",
      shareTitle: "Sdílej odkaz na garáž",
      shareBody: "Pošli odkaz nebo QR na svou výlohu — přátelé a blok tě najdou rychle.",
      helpTitle: (mascot) => `${mascot} ti drží záda`,
      helpBody: (mascot) => `${mascot} odpovídá na otázky, navrhuje odpovědi a provede tě inzerátem i rezervací.`,
      ctaTitle: "Až budeš připravený",
      ctaBody: "Prohlížení je zdarma. Účet odemkne inzeráty, rezervace a chat.",
      artPlaceholder: (id) => `Obrázek přijde — ${id}`,
      nextCta: "Další",
      signUpCta: "Vytvořit účet zdarma",
      browseCta: "Pokračovat jako host",
      footerHint: "Prohlížení je zdarma. Účet odemkne inzeráty, rezervace a chat.",
    },
  },
  profileDeep: {
    personalInfo: {
    ...
    coHosts: {
      ...
      saving: "Ukládám...",
      sending: "Posílám pozvánku...",
      saveInvite: "Uložit pozvánku",
      sendInvite: "Poslat pozvánku e-mailem",
      shareInviteLink: "Záložní odkaz",
      copyLink: "Kopírovat odkaz",
      inviteHint:
        "Pozvánku pošleme e-mailem. Přihlásí se tím e-mailem a přijmou ji v Pozvánky pro tebe. Odkaz si pořád můžeš zkopírovat jako zálohu.",
      ...
      inviteEmailed: "Pozvánka odeslána e-mailem. Ať zkontrolují schránku (i Spam).",
      inviteSavedEmailFailed: (detail) =>
        `Pozvánka uložena, ale e-mail neodešel (${detail}). Zkopírujte odkaz níže a pošlete ho sami.`,
...
sellPathChoice: {
    title: "Jak chceš prodat?",
    intro:
      "Nech to live v garáži kdykoli — nebo spusť krátký Open Sale (30–60 min), kde sousedé draží z košíku.",
    liveTitle: "Live v mé garáži",
    liveBody: "Hned na hlavní polici. Sousedé koupí za tvoji cenu. Bez časované aukce.",
    liveCta: "Nechat live →",
    openSaleTitle: "Open Sale z garáže",
    openSaleBody:
      "Vyber tuhle věc (a další). Hlavní garáž bude neaktivní s odznakem Aukce, dokud prodej neskončí.",
    openSaleCta: "Naplánovat Open Sale →",
    snapTitle: "Open Sale + fotit další",
    snapBody:
      "Spusť Open Sale a foť další loty rovnou na police prodeje — ne přesun z obchodu.",
    snapCta: "Open Sale + foťák →",
  },
  openSaleCreate: {
    title: "Open Sale",
    subtitle: "Předprodej → 30–60 min živé nabídky → jeden checkout",
    whenStarts: "Kdy začíná",
    startSoon: "Za ~10 min",
    startIn1h: "Za 1 hodinu",
    startTomorrow: "Zítra v 9:00",
    liveWindow: "Živé okno",
    minutes: (m) => `${m} min`,
    liveHint: "Nech to krátké — když to táhne, lidé ztratí zájem.",
    mirrorTitle: (count) => `Zrcadlit z garáže (vybráno ${count})`,
    mirrorBody:
      "Vybrané karty v hlavním obchodě zmizí s odznakem Aukce. Sousedé draží z košíku (zelená = vede, šedá = přebito).",
    emptyListings: "Zatím žádné prodejní nabídky — místo toho foť věci rovnou na prodej.",
    saleItemFallback: "Položka na prodej",
    minStep: (min, step) => `Min $${min} · krok $${step}`,
    pickOneError: "Vyber aspoň jednu položku",
    creating: "Vytvářím…",
    publishCta: "Publikovat Open Sale",
    snapMoreCta: "Foť další loty na tento prodej →",
  },
};
