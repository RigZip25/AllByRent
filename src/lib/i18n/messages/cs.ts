...
export const cs: AppMessages = {
  ...
  onboarding: {
    ...
    guestShowcase: {
      photosTitle: "Vyfoť — text napíšeme my",
      photosBody: "Jedna fotka. Název, kategorie a popis se doplní sami.",
      enhanceTitle: "Fotky, které prodávají",
      enhanceBody: "Čistší pozadí a lepší světlo — sousedé víc věří tomu, co vidí.",
      rolesTitle: "Půjčit · Prodat · Darovat",
      rolesBody: "Jedna garáž. Tři způsoby sdílení. Kdykoli přepneš.",
      roleRent: "Půjčit",
      roleRentHint: "Vydělávej, zatímco si sousedé půjčí foťák, nářadí a další.",
      roleSell: "Prodat",
      roleSellHint: "Prodej, co nepotřebuješ — bez chaosu inzerátů.",
      roleGift: "Darovat",
      roleGiftHint: "Předej věci zdarma někomu poblíž.",
