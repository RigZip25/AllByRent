...
export const garageSale: AppMessages["garageSale"] = {
  ...
  snapSale: {
    ...
    setupStripeTitle: "Want to get paid? (optional)",
    setupStripeBody:
      "To receive money from neighbors, verify your ID and connect a bank (powered by Stripe). You can put items on the shelf now and finish this later.",
    ...
    publishPayoutHint:
      "On the shelf without payouts yet — set up above when you want to receive card payments.",
