...
import guestBookHandoffV2 from "../../imports/onboarding/evorios_guest_book_handoff_v2.webp";
import guestBrowseNeighborhood from "../../imports/onboarding/evorios_guest_browse_neighborhood.webp";
import guestEnhanceInventory from "../../imports/onboarding/evorios_guest_enhance_inventory.webp";
import guestHelpGatewayV2 from "../../imports/onboarding/evorios_guest_help_gateway_v2.webp";
import guestHookGarage from "../../imports/onboarding/evorios_guest_hook_garage.webp";
import guestModesExchange from "../../imports/onboarding/evorios_guest_modes_exchange.webp";
import guestSnapBikeV2 from "../../imports/onboarding/evorios_guest_snap_bike_v2.webp";
import guestYardNetworkV2 from "../../imports/onboarding/evorios_guest_yard_network_v2.webp";
import guestShareNetworkV2 from "../../imports/onboarding/evorios_guest_share_network_v2.webp";
  ...
  const slides: { id: SlideId; title: string; body: string; visual: SlideVisual }[] = useMemo(
    () => [
      ...
      },
      {
        ...
        visual: { kind: "image", src: guestBookHandoffV2 },
      },
      {
        id: "yard",
        title: copy.yardTitle,
        body: copy.yardBody,
        visual: { kind: "image", src: guestYardNetworkV2 },
      },
      {
        id: "share",
        title: copy.shareTitle,
        body: copy.shareBody,
        visual: { kind: "image", src: guestShareNetworkV2 },
      },
      {
        id: "help",
