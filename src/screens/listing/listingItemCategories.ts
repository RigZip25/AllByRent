...
export const CATEGORIES: Record<string, CategoryData> = {
  ...
  "Home & Office Furniture": {
    icon: "🛋️",
    personal: [
      subArt("Living Room Furniture", "🛋️", "furniture-living-room-furniture"),
      subArt("Bedroom Furniture", "🛏️", "furniture-bedroom-furniture"),
    ...
    professional: [
      ...
      subArt("Reception Furniture", "🛎️", "furniture-reception-furniture"),
      subArt("Conference Furniture", "🗣️", "furniture-conference-furniture"),
