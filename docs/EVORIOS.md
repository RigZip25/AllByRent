...
## Product concept (current)

Each **household** is an online storefront. **Garage-sale culture** (US) is the mental model: familiar, local, porch/yard — without saying “sale” in the brand.

**Listing modes (already in code):** rent · sell · rent-to-own · gift.

**App modes:** Earn (host / my store) · Rent (browse neighborhood).
...
| Date | Change |
|------|--------|
| 2026-05-28 | Brand direction fixed: **Evorios** = site + mascot; evolution narrative (household, consumption, relationships). Wyoming company. This doc added. |
| 2026-05-28 | Engineering: tasks 15–18 on branch `cursor/stripe-renter-payment-ca09`, PR #16 open. |
| | *Next entry: merge payments / rebrand / evorios.com live* |
